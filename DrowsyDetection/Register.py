    ...
    def registering(self):
        try:
            ...
            if name == "" or name == "null" or unm == "" or unm == "null" or pwd == "" or pwd == "null" or email == "" or email == "null" or mno == "" or mno == "null":
                ...
                sql = "select count(*) from driver_register where driver_uid='" + unm + "'"
                cursor.execute(sql)
                res = cursor.fetchone()[0]
                if res > 0:
                    self.showMessageBox("Information", "User Name already exists..!")
                else:
                    sql = "insert into driver_register values(%s,%s,%s,%s,%s)"
...
"font: 75 14pt \"Times New Roman\";")
        ...
        self.label_7.setStyleSheet("image: url(../DrowsyDetection/images/registration.png);")
