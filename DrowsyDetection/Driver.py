...
from DriverHome import Ui_driverhome
    ...
    def driverlogin(self):
        try:
            ...
            if unm == "" or unm == "null" or pwd == "" or pwd == "null":
                ...
                sql = "select count(*) from driver_register where driver_uid='" + unm + "' and driver_pwd='" + pwd + "'"
                cursor.execute(sql)
                res = cursor.fetchone()[0]
                if res > 0:
                    self.drhome = QtWidgets.QDialog()
                    self.ui1 = Ui_driverhome(self.drhome, unm)
                    self.ui1.setupUi(self.drhome)
                    self.drhome.show()
                    self.dialog.hide()
                else:
                    self.showMessageBox("Information", "Invalid Login Credentials..!")
        except Exception as e:
            print("Error=" + e.args[0])
            tb = sys.exc_info()[2]
            print(tb.tb_lineno)
...
"color: rgb(255, 255, 255);")
        ...
        self.pushButton.clicked.connect(self.driverlogin)
        self.label_4 = QtWidgets.QLabel(Dialog)
        self.label_4.setGeometry(QtCore.QRect(420, 80, 211, 291))
        self.label_4.setStyleSheet("image: url(../DrowsyDetection/images/driverr.png);")
        self.label_4.setText("")
        self.label_4.setObjectName("label_4")
        self.register_2 = QtWidgets.QLabel(Dialog)
        self.register_2.setGeometry(QtCore.QRect(470, 330, 121, 65))
        self.register_2.setStyleSheet("image: url(../DrowsyDetection/images/register-now.png);")
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Driver Login"))
        self.label.setText(_translate("Dialog", "        Driver Login"))
